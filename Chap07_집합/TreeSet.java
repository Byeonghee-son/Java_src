...
public class TreeSet {
	...
	Sets s1 = new Sets(20);
	s1.SimpleUnion(0,1);s1.SimpleUnion(1,2);s1.SimpleUnion(2,3);s1.SimpleUnion(3,4);
	s1.SimpleUnion(7,8);s1.SimpleUnion(8,9);s1.SimpleUnion(6,7);s1.SimpleUnion(7,8);
	s1.display();
