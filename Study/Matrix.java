...
public class Matrix {
	...
	protected static Matrix addMatrix(Matrix m1, Matrix m2) {
		...
		Matrix result = new Matrix(m1.rowsCount, m1.colCount);

		for (int r = 0; r < m1.rowsCount; r++) {
	...
	protected Matrix Transpose() {
		Matrix result = new Matrix(colCount,rowsCount);
		...
		protected static Matrix matrixmultiply(Matrix m1, Matrix m2) {
			Matrix result = new Matrix(m1.rowsCount, m2.colCount);
